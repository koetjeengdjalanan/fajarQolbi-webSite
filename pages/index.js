              ...
              headLine.map((head) => (
                <Carousel.Item interval={5000} key={head.id}>
                  <img
                    ...
                    src={`https://fajarqolbi-proddatabase.herokuapp.com${head.thumbnail.url}`}
                    alt={`https://fajarqolbi-proddatabase.herokuapp.com${head.thumbnail.slug}`}
                  />
                ...
                blogPost.map((blog) => (
                  ...
                  >
                    <Card style={{ width: "18rem" }}>
                      <Card.Img
                        variant="top"
                        src={`https://fajarqolbi-proddatabase.herokuapp.com${blog.thumbnail.url}`}
