 ...
 return (
  ...
  >
   <div className="row my-5" style={{ backgroundColor: "#86D07E" }}>
    <div className="d-flex align-items-center col-md-8 col-sm-12">
     <div>
    ...
    <div className="d-flex justify-content-center align-items-center p-3 col-md-4 col-sm-12">
   ...
   <div className="row my-5" style={{ backgroundColor: "#86D07E" }}>
    ...
    <div className="d-flex align-items-center col-md-8 col-sm-12">
     <div>
      ...
      <ul>
       <li>
        Membantu Memberikan Beasiswa Biaya Sekolah Anak Yatim Piatu & Dhuafa
        Yang Menjadi Binaan Yayasan Fajar Qolbi per 6 Bulan Sekali &
        Didistibuskan kesekolah Masing-Masing Anak.
       </li>
       <li>
       ...
       <li>
        Pemberian Uang Saku, Sebesar Rp.150.000,- / bulan Setiap Anak
        (Rp.5.000,- / hari)
       </li>
       <li>
